...
const Footer = () => {
  return (
    ...
    <footer className="bg-black font-sans tracking-wide  py-4 ">
      <div className="px-4 md:px-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-44 gap-y-10">
        <div>
          <a className="text-white text-2xl font-semibold" href="javascript:void(0)">
           E-shop
          </a>
      ...
      <div className="flex flex-wrap max-md:flex-col gap-4 px-4 md:px-16">
